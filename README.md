...
| [ClipForge](https://github.com/JooaoPedro15/Careca-Studio) | Aplicativo desktop modular para centralizar ferramentas de produção de conteúdo, automação com IA, legenda, análise de mídia e suporte comercial. | Electron, React, TypeScript, Vite, Python, IA |
